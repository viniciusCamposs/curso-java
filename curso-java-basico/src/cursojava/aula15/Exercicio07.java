...
public class Exercicio07 {
	...
	public static void main(String[] args) {
		try (Scanner scan = new Scanner(System.in)) {
			...
			if(numero1 < numero2 && numero1 < numero3) {
				System.out.println("Número 1 é o menor dos números digitados");
			}else if(numero2 < numero1 && numero2 < numero3) {
				System.out.println("Número 2 é o menor dos números digitados");
			}else if(numero3 < numero1 && numero3 < numero1) {
				System.out.println("Número 3 é o menor dos números digitados");
			}else {
				System.out.println("Os números são iguais");
			}
		}
