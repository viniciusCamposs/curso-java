...
public class Aula78 {
	public static void main(String[] args) {
		...
		System.out.println("ola == ola4 = " +  ola.equals(ola4)); //true
		...
		System.out.println(a.compareTo(b)); // -1 quando a>b // 0 quando a == b // 1 ou >1 quando a<b
		System.out.println(b.compareTo(a));
		System.out.println(a.compareTo(aMaisculo));
		System.out.println(b.compareTo(aMaisculo));
	}
}
